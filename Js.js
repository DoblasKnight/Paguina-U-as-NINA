...
function showForm() {
  ...
  document.getElementById("summary-info").innerText =
    `${currentSelection.date} a las ${currentSelection.time}`;
}
...
document
  ...
  .addEventListener("submit", async (e) => {
    ...
    if (dbError) {
      ...
      closeModal();
      document.getElementById("booking-form").reset(); // Opcional: recargar para actualizar el calendario visualmente
      // location.reload();
    }
